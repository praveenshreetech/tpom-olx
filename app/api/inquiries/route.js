...
export async function POST(request) {
  try {
    ...
    const { product_id, product_name, buyer_name, buyer_phone, buyer_email, message, contact_method } = body
...
*Product Price:* ${product_price ? `₹${Number(product_price).toLocaleString('en-IN')}` : 'Contact for price'}
